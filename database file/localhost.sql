...
--
-- Host: localhost
-- Generation Time: Mar 07, 2014 at 02:45 PM
...
-- Database: `abhishek`
--
CREATE DATABASE IF NOT EXISTS `abhishek` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `abhishek`;
...
INSERT INTO `names` (`enrolment`, `name`, `branch`, `year`, `gender`, `serial`) VALUES
('1324654', '', '', NULL, 'male', 2),
('13456464', 'lfdhlkjaf', 'gfj', '2014-03-19', 'male', 1);
--
-- Database: `mess_fy13`
--
...
CREATE TABLE IF NOT EXISTS `students` (
  ...
  `semester` varchar(10) NOT NULL COMMENT 'current semester',
